    ...
    return (
      <div className="Board">
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-4" ref={this.swimlanes.backlog}>
              {this.renderSwimlane(
                "Backlog",
            ...
            <div className="col-md-4" ref={this.swimlanes.inProgress}>
              {this.renderSwimlane(
                "In Progress",
            ...
            <div className="col-md-4" ref={this.swimlanes.complete}>
              {this.renderSwimlane(
                "Complete",
